    ...
    render () {
        ...
        return (
            ...
            <Jumbotron>
                ...
                <div className="lead"> <Row>
                    <Col sm="4"> <Card>
                        ...
                        <CardBody>
                            ...
                            <InputGroup>
                                    <Input value={skill} id="skillInput" placeholder="Python" onChange={this.handleChange}/>
                                    <InputGroupAddon addonType="append">
                                        <Button color="success" id="addSkill" onClick={this.handleClick}>Add</Button>
                                    </InputGroupAddon>
                            </InputGroup>
                        </CardBody>
                        <CardFooter className="text-muted"> <ListGroup>
                            <ShowList list={this.state.skills} onRemoveItem={this.onRemoveSkills}/>
                            {/* List Example */}
                    ...
                    {/* Courses Card */}
                    <Col sm="4"> <Card>
                        <CardHeader tag="h3">Courses</CardHeader>
                        <CardBody>
                            <CardTitle>Add the courses you have taken</CardTitle>
                            <InputGroup>
                                    <Input value={course} id="courseInput" placeholder="MA3402" onChange={this.handleChange}/>
                                    <InputGroupAddon addonType="append">
                                        <Button color="danger" id="addCourse" onClick={this.handleClick}>Add</Button>
                                    </InputGroupAddon>
                            </InputGroup>
                        </CardBody>
                        <CardFooter className="text-muted"> <ListGroup>
                            <ShowList list={this.state.courses} onRemoveItem={this.onRemoveCourses}/>
                            {/* List Examples */}
                ...
                <p className="lead"></p> 
                <p className="lead">
                    <Button color="primary" id="submitButton" onClick={this.handleClick}>Submit</Button>{' '}
                    <Button color="danger" id="discardButton" onClick={this.handleClick}>Discard</Button>{' '}
                </p>
            </Jumbotron>
            {/*Course List Page */}
            {showCourseList &&
